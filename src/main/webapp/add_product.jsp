            ...
            <form action="insert" method="post">
                ...
                <fieldset class="form-group">
                    <label>Price</label> <input type="text" class="form-control"
                                                name="priceProduct" required="required">
                </fieldset>
                <fieldset class="form-group">
                    <label>Describe</label> <input type="text" class="form-control"
                                                name="describe" required="required">
                </fieldset>
                <fieldset class="form-group">
                    <label>Vendor</label> <input type="text" class="form-control"
                                                name="vendor" required="required">
                </fieldset>
                <fieldset class="form-group">
